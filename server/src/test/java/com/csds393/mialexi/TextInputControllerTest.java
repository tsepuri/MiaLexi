...
public class TextInputControllerTest {
	...
	void testPdf() throws IOException {
		...
		assertEquals(ti.pdfToString(System.getProperty("user.dir")+"\\Test2.pdf").trim(), "Test one two three");
	}
	...
	void testTxt() throws FileNotFoundException {
		...
		assertEquals(ti.txtToString(System.getProperty("user.dir")+"\\test1").trim(), "Test one two three");
	}
}
